...
# Audios
text = """De verzamelde gegevens worden opgeslagen op door de TU/e ondersteunde opslagfaciliteiten.              
...
# Audios
text = """Als u meer informatie wilt over deze studie, het onderzoeksontwerp of de resultaten, kunt u contact opnemen met François Leborgne (contact email: f.m.g.leborgne@tue.nl ) of Sichen Guo (contact email: s.guo3@tue.nl). 
...
# Audios
text = """1️⃣ Ik heb voldoende informatie over het onderzoeksproject van het aparte informatieblad. Ik heb het gelezen en ik heb de kans gehad om vragen te stellen, die naar tevredenheid zijn beantwoord.
